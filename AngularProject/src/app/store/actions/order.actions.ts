...
export const GetOrdersListSuccess = createAction('GET_ORDER_LIST_SUCCESS', props<{orderAccount : any[]}>())
...
export const GetAllOrdersSuccess = createAction('GET_ALL_ORDERS_SUCCESS', props<{orderAccounts : any[]}>())
