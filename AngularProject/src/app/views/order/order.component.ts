...
export class OrderComponent implements OnInit {
  ...
  constructor(private store : Store<IAppState>, private fb: FormBuilder, private auth_service : AuthService) { 
  ...
  addOrder(){
   ...
   console.log(order);
   let token = this.auth_service.getTokenDetails();
   this.store.dispatch(AddOrderAction({item: order, user_id : token.user_id}));
  }
